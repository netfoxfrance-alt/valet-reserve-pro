      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            {/* Right: Two distinct mockup cards side by side */}
            <div className="flex justify-center lg:justify-end mt-8 lg:mt-0">
              <div className="relative w-[340px] sm:w-[480px] md:w-[560px] h-[580px] sm:h-[560px] md:h-[600px]">
                
                {/* Card 1: Page professionnelle - Left, slightly tilted */}
                <div className="absolute top-8 sm:top-6 left-0 sm:left-0 z-20">
                  <div 
                  ...
                  >
                    ...
                    <div className="px-3 pb-4 pt-10 text-center">
                      ...
                      <p className="text-[9px] text-muted-foreground leading-relaxed mb-2 px-1">
                      ...
                      <div className="space-y-1 mb-3 text-left px-1">
                        ...
                        <div className="flex items-center gap-1.5 text-[9px] text-muted-foreground">
                          ...
                          <span>{t('mockup.mon')} - {t('mockup.sat')} : 9h - 19h</span>
                        </div>
                        <div className="flex items-center gap-1.5 text-[9px] text-muted-foreground">
                      ...
                      <button className="w-full bg-zinc-800 text-white rounded-xl py-2.5 text-[10px] font-semibold">
                        {t('mockup.bookNow')}
                      </button>
                    </div>
                  </div>
                ...
                {/* Card 2: Dashboard - Right, tilted the other way */}
                <div className="absolute top-4 sm:top-0 right-0 sm:right-0 z-10">
                  <div 
                    className="bg-card rounded-[2rem] overflow-hidden w-[210px] sm:w-[240px] shadow-2xl shadow-black/15 ring-1 ring-border/40"
                    style={{ transform: 'rotate(3deg)' }}
                  >
                    {/* Dashboard top bar */}
                    <div className="px-4 pt-4 pb-3 bg-secondary/20">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                          <div className="w-7 h-7 bg-primary/10 rounded-xl flex items-center justify-center">
                            <BarChart3 className="w-3.5 h-3.5 text-primary" />
                          </div>
                          <p className="text-[11px] font-bold text-foreground">{t('landing.heroDashTitle')}</p>
                        </div>
                      </div>
                      
                      {/* KPI cards */}
                      <div className="grid grid-cols-2 gap-2">
                        <div className="bg-card rounded-xl p-2.5 ring-1 ring-border/20 shadow-sm">
                          <div className="flex items-center gap-1.5 mb-1">
                            <Calendar className="w-3 h-3 text-primary" />
                            <span className="text-[8px] text-muted-foreground">{t('landing.heroDashRdv')}</span>
                          </div>
                        ...
                        <div className="bg-card rounded-xl p-2.5 ring-1 ring-border/20 shadow-sm">
                          <div className="flex items-center gap-1.5 mb-1">
                            ...
                            <span className="text-[8px] text-muted-foreground">{t('landing.heroDashCa')}</span>
                          </div>
                          <p className="text-lg font-bold text-emerald-600 leading-none">4.2k€</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="px-4 py-3 border-b border-border/20">
                      <p className="text-[8px] text-muted-foreground mb-2 font-medium">{t('landing.heroDashCa')} — 6 {t('landing.heroDashMonths')}</p>
                      <div className="flex items-end gap-1 h-10">
                        {[40, 55, 35, 70, 60, 85].map((h, i) => (
                          <div key={i} className="flex-1 rounded-t-md bg-emerald-500/20" style={{ height: `${h}%` }}>
                            <div className={`w-full rounded-t-md ${i === 5 ? 'bg-emerald-500' : 'bg-emerald-500/50'}`} style={{ height: '100%' }} />
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="px-3 py-3 space-y-1.5">
                      <p className="text-[8px] font-semibold text-muted-foreground uppercase tracking-wider mb-1">{t('landing.heroDashUpcoming')}</p>
                      {[
                        ...
                        { name: 'Julie M.', time: '16:30', service: 'Polissage premium', color: 'bg-violet-500' },
                      ].map((apt, i) => (
                        <div key={i} className="flex items-center gap-2 p-2 rounded-xl bg-secondary/30 border border-border/15">
                          <div className={`w-1 h-7 ${apt.color} rounded-full flex-shrink-0`} />
                          ...
                          <span className="text-[9px] font-semibold text-muted-foreground flex-shrink-0">{apt.time}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                {/* Small floating widget: Rating - top left of page card */}
                <div className="absolute -top-2 sm:-top-1 left-4 sm:left-12 z-30">
                  <div 
                ...
                {/* Small floating widget: Clients count - between cards */}
                <div className="absolute bottom-16 sm:bottom-20 left-[42%] sm:left-[44%] z-30">
                  <div 
